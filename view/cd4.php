<h2>Contexto de la organización</h2>
    ...
    <form id="oManual" enctype="multipart/form-data" method="post" action="../control/guardaOp.php">
        ...
        <input type="hidden" name="apartado" value='4' id="opcion">
        <h3>4.1 Comprensión de la organizacion y de su contexto.</h3>
            <textarea id="campo1" name="campo1"><?php echo $campo[1]; ?></textarea>
        <h3>4.2 Comprensión de las necesedades y expectativasde las partes interesadas.</h3>
            <textarea id="campo2" name="campo2"><?php echo $campo[2]; ?></textarea>
        <h3>4.3 Determinacion del alcance del sistema de gestiónde la calidad.</h3>
            <textarea id="campo3" name="campo3"><?php echo $campo[3]; ?></textarea>
        ...
        de esta Norma internacional.</h3>
            <textarea id="campo4" name="campo4"><?php echo $campo[4]; ?></textarea>
        <h3>4.4.2 En medida que sea necesario, la organizacion debe.</h3>
            <textarea id="campo5" id="texto" name="campo5"><?php echo $campo[5]; ?></textarea>
        <br>
